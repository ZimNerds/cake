    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('isBanned') ?></th>
                <th scope="col"><?= $this->Paginator->sort('isApproved') ?></th>
                <th scope="col"><?= $this->Paginator->sort('pass_reset_key') ?></th>
                <th scope="col"><?= $this->Paginator->sort('pass_reset_expiry') ?></th>
